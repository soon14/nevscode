...
public final class ActivityUtil {
    ...
    public static void showUiToast(final String str){
        ...
        handlerThree.post(new Runnable(){
            public void run(){
                ActivityUtil.showToast(MyApp.getInstance(),str);
            }
        });


    }
    public static void showUiLongToast(final String str){
        Handler handlerThree=new Handler(Looper.getMainLooper());
        handlerThree.post(new Runnable(){
            public void run(){
                ActivityUtil.showLongToast(MyApp.getInstance(),str);
            }
        });
...
//        // Toast toast = Toast.makeText(context, str, Toast.LENGTH_SHORT);
//
//        Toast toast = ToastFactory.getLongToast(context, str);
//        toast.setGravity(Gravity.CENTER, 0, 0);
//        toast.show();
//
//
...
//    }
    ...
    /**
     *
     * @param type 1：选择点位在屏幕上半部分 2：点位在中间
     * @return Point
     */
    public static Point getPoint(int type) {
    ...
    public static void show(final Activity activity, final String message) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Toast toast = ToastFactory.getToast(activity, msg);
                toast.setGravity(Gravity.CENTER, 0, 0);
                toast.show();
            }
        });
    ...
    public static void show(final Context context, final String message) {
        final String msg = message == null ? "" : message;
        MyApp.getInstance().getTopActivity()
                .runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast toast = ToastFactory.getToast(MyApp
                                .getInstance().getTopActivity(), msg);
...
//	}
    ...
    public static void showToast(Context context, int resId) {
        // Toast toast = Toast.makeText(context, str, Toast.LENGTH_SHORT);
        Toast toast = ToastFactory.getToast(context, resId);
        toast.setGravity(Gravity.CENTER, 0, 0);
        toast.show();
    }
