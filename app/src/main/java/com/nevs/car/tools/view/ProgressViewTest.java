...
public class ProgressViewTest extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //设置画笔颜色
        mPaint.setColor(getResources().getColor(R.color.text_default));
        int round = mHeight/2;
        /**
       ...
       // mPaint.setColor(Color.rgb(211, 211, 211));
        mPaint.setColor(MyApp.getInstance().getResources().getColor(R.color.pro_green));
        RectF rectBlackBg = new RectF(2, 2, mWidth-2, mHeight-2);
       // canvas.drawRoundRect(rectBlackBg, round, round, mPaint);
        //canvas.drawRect(rectBlackBg, round, round, mPaint);
        ...
        if(section!=0.0f){
           // mPaint.setColor(getResources().getColor(R.color.text_default));
            mPaint.setColor(MyApp.getInstance().getResources().getColor(R.color.pro_yellow));
        }else{
            mPaint.setColor(MyApp.getInstance().getResources().getColor(R.color.pro_yellow));
        }
