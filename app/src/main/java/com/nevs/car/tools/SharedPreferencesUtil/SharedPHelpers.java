...
public class SharedPHelpers {
    ...
    public SharedPHelpers(Context context,String flieName) {
        try {
            sharedPreferences = context.getSharedPreferences(flieName, Context.MODE_PRIVATE);
...
//     * 搜索记录
//     */
//    public SharedPHelpers(Context context,String file_name) {
