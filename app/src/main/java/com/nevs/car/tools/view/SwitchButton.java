...
import com.nevs.car.tools.util.ColorUtilsry;
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = ColorUtilsry.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = ColorUtilsry.generateBackColorWithTintColor(mTintColor);
