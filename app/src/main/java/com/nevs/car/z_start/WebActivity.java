                ...
                switch (msg.what) {
                    case 0:
                        if (WebActivity.this.isFinishing())
                            return;
                        //pd.show();//显示进度对话框
                        DialogUtils.webloading(WebActivity.this, true, mDialog);
                        MLog.e("显示");
                        break;
                    case 1:
                        if (WebActivity.this.isFinishing())
                        ...
                        DialogUtils.webhidding(WebActivity.this, mDialog);
                        MLog.e("隐藏");
                        break;
                }
            }
...
//// 设置缓冲大小，我设的是8M
//        settings.setAppCacheMaxSize(1024 * 1024 * 12);
...
//        pd.setMessage("数据载入中，请稍候！");
        //文字即为显示的内容
        mDialog = DialogUtils.createLoadingDialog(WebActivity.this, getResources().getString(R.string.loading));
    }
...
//        return super.onKeyDown(keyCode, event);
        ...
        if ((keyCode == KeyEvent.KEYCODE_BACK) && wv.canGoBack()) {
            ...
            WebActivity.this.finish();//按了返回键，但已经不能返回，则执行退出确认
            return true;
        }
        return super.onKeyDown(keyCode, event);
    }
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_title:
                break;
            case R.id.share:
                DialogUtils.shareDiolag(WebActivity.this, wxShare, url, title);
                break;
        }
    }
