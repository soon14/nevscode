...
public class ProxyNewFragment extends BaseFragment {
    ...
    public int getLayoutResId() {
        return R.layout.fragment_proxy_new;
    }
    ...
    private void getHttp() {
         ...
         * 参数名称	类型	是否必填	说明
         ...
         status	字符串	是	查询状态 跟进 30251001  战败 30251003 成功 30251004
         create_by	字符串	是	用户id
         * */
        ...
        HttpRxUtils.getPaProyQuery(getContext(),
                ...
                new Object[]{new SharedPHelper(getContext()).get(Constant.ACCESSTOKEN, ""),
                        "30251001",new SharedPHelper(getContext()).get(Constant.LOGINNAME,"")},
                new HttpRxListener() {
                    @Override
                    public void onSucc(Object obj) {
                        ...
                        myAdapter = new ProxyNewAdapter(R.layout.item_newproxy, list); //设置适配器
    ...
    private void initOnclickListener() {
        ...
        myAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                listProxy.add(new ProxyallBean(1,
