...
import com.nevs.car.activity.my.HistoryOrderActivity;
import com.nevs.car.adapter.BaseQuickAdapter;
import com.nevs.car.adapter.HistoryOrderAdapter;
        ...
        HttpRxUtils.getMyBooking(getContext(),
                ...
                new HttpRxListener() {
                    ...
                    public void onSucc(Object obj) {
                        ...
                        myAdapter = new HistoryOrderAdapter(R.layout.item_server, list); //设置适配器
    ...
    private void initOnclickListener() {
        ...
        myAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                MLog.e("booking_no历史:" + list.get(position).get("booking_no").toString());
                getContext().startActivity(new Intent(getContext(), HistoryOrderActivity.class)
