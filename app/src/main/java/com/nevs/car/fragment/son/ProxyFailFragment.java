...
public class ProxyFailFragment extends BaseFragment {
    ...
    public int getLayoutResId() {
        return R.layout.fragment_proxy_fail;
    }
    ...
    private void getHttp() {
        ...
        HttpRxUtils.getPaProyQuery(getContext(),
                ...
                new Object[]{new SharedPHelper(getContext()).get(Constant.ACCESSTOKEN, ""),
                        "30251003",new SharedPHelper(getContext()).get(Constant.LOGINNAME,"")},
                new HttpRxListener() {
                    @Override
                    public void onSucc(Object obj) {
                        ...
                        //////cc 界面确定再增加
                        myAdapter = new ProxyNewAdapter(R.layout.item_failproxy, list); //设置适配器
    ...
    private void initOnclickListener() {
        ...
        myAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                listProxy.add(new ProxyallBean(2,
