...
import com.nevs.car.tools.animation.AlphaInAnimation;
import com.nevs.car.tools.animation.BaseAnimation;
import com.nevs.car.tools.animation.CustomAnimation;
import com.nevs.car.tools.animation.ScaleInAnimation;
import com.nevs.car.tools.animation.SlideInBottomAnimation;
import com.nevs.car.tools.animation.SlideInLeftAnimation;
import com.nevs.car.tools.animation.SlideInRightAnimation;
    ...
    public void setCustomLoadMoreView(View footerView) {
        if (footerView instanceof IFooterCallBack) {
            ...
            if (mParent != null && mParent.getContentView() != null) {
                mParent.getContentView().initFooterCallBack2(this, mParent);
            }
