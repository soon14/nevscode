package com.nevs.car.adapter.xrefreshview;
...
import com.nevs.car.adapter.xrefreshview.callback.IFooterCallBack;
import com.nevs.car.adapter.xrefreshview.listener.OnBottomLoadMoreTime;
import com.nevs.car.adapter.xrefreshview.listener.OnTopRefreshTime;
import com.nevs.car.adapter.xrefreshview.recyclerview.BaseRecyclerAdapter;
import com.nevs.car.adapter.xrefreshview.recyclerview.XSpanSizeLookup;
import com.nevs.car.adapter.xrefreshview.utils.LogUtils;
...
//                        addFooterView(true);
    ...
    public void initFooterCallBack2(BaseQuickAdapter adapter, XRefreshView parent) {
        if (!mSilenceLoadMore) {
            if (adapter != null) {
                View footerView = adapter.getCustomLoadMoreView();
                if (null == footerView) {
...
// cc           WebView webview = (WebView) child;
//            return canScrollVertically(child, 1)
