...
public class LogSettingA extends BaseQuickAdapter<HashMap<String,Object>> {
    public LogSettingA(int layoutResId, List<HashMap<String, Object>> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HashMap<String, Object> item) {
        helper.setText(R.id.poi_title,item.get("title")+"");//"poiName"
