...
public class HistoryOrderAdapter extends BaseQuickAdapter<HashMap<String,Object>> {
    public HistoryOrderAdapter(int layoutResId, List<HashMap<String,Object>> data) {
