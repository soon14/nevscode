...
public class KeepEnterActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.activity_keep_enter;
    }
    ...
    private void getHttp() {
        DialogUtils.loading(KeepEnterActivity.this, true);
        HttpRxUtils.getRepairDetails(KeepEnterActivity.this,
                new String[]{"accessToken", "ro_no"},
                new Object[]{new SharedPHelper(KeepEnterActivity.this).get(Constant.ACCESSTOKEN, ""),
                        ro_no
                },
                new HttpRxListener() {
                    @Override
                    public void onSucc(Object s) {
                        DialogUtils.hidding(KeepEnterActivity.this);
    ...
    private void showDialog() {
        dialog = new CustomDialog(KeepEnterActivity.this);
        dialog.show();
    }
    ...
    private void getPing() {
        DialogUtils.loading(KeepEnterActivity.this, true);
        listPing.clear();
        HttpRxUtils.getGetServiceEalution(KeepEnterActivity.this,
    ...
    private void getSpeak() {
        ...
        HttpRxUtils.getServiceEalution(KeepEnterActivity.this,
                new String[]{"accessToken", "service_ealution"},
                new Object[]{new SharedPHelper(KeepEnterActivity.this).get(Constant.ACCESSTOKEN, ""),
                        new ServiceEalution((String) new SharedPHelper(KeepEnterActivity.this).get(Constant.LOGINNAME, ""),
                ...
                new HttpRxListener() {
                    ...
                    public void onSucc(Object s) {
                        ...
                        ActivityUtil.showToast(KeepEnterActivity.this, getResources().getString(R.string.toast_submitsuccess));
                        if (dialog != null) {
                            dialog.dismiss();
                        }
                    }
