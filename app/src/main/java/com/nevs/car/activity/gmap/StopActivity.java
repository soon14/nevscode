...
public class StopActivity extends BaseActivity implements LocationSource, AMapLocationListener
        ...
        if (aMapLocation != null) {
            if (aMapLocation.getErrorCode() == 0) {
                ...
                if (isFirstLoc) {
                    ...
                    searchPoi("停车场", 0, aMapLocation.getCityCode(), true, aMapLocation.getLatitude(), aMapLocation.getLongitude());
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        if (GaodeNaiUtils.isInstallPackage()) {
                            ...
                            ActivityUtil.showToast(StopActivity.this, getResources().getString(R.string.toast_installgao));
                        }
                        break;
                    case 1:
                        //百度地图
                        if (BaiduNaiUtils.isInstalled()) {
                            ...
                            ActivityUtil.showToast(StopActivity.this, "请先安装百度地图客户端");
                        }
                        break;
                }
                if (dialog != null) {
...
//                        list.get(i-1).setAlpha(0);
    ...
    private void getTsp3() {
        ...
        MLog.e("float" + d);
        DialogUtils.loading(StopActivity.this, true);
        TspRxUtils.getSavePoi(this,
                new String[]{Constant.TSP.CONTENTTYPE, Constant.TSP.ACCEPT, Constant.TSP.AUTHORIZATION},
                new Object[]{Constant.TSP.CONTENTTYPEVALUE, Constant.TSP.ACCEPTVALUE, "Bearer" + " " + new SharedPHelper(StopActivity.this).get(Constant.ACCESSTOKENS, "")},
                new String[]{"poiId", "poiName", "longitude", "latitude", "address"},
                new Object[]{new SharedPHelper(StopActivity.this).get(Constant.LOGINNAME, "") + String.valueOf(lat) + String.valueOf(lon),
                        name,
                        lon,
                        lat,
                        text},
                new TspRxListener() {
                    ...
                    public void onSucc(Object obj) {
                        DialogUtils.hidding(StopActivity.this);
                        ActivityUtil.showToast(StopActivity.this, getResources().getString(R.string.toast_collectsuc));
                    ...
                    public void onFial(String str) {
                        DialogUtils.hidding(StopActivity.this);
                        if (str.contains("400")) {
                            ActivityUtil.showToast(StopActivity.this, getResources().getString(R.string.toast_exists));
                        } else {
                            ActivityUtil.showToast(StopActivity.this, getResources().getString(R.string.toast_collectfail));
                        }
