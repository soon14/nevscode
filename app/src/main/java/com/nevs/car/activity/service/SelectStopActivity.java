...
public class SelectStopActivity extends BaseActivity implements BaseQuickAdapter.OnRecyclerViewItemClickListener {
    ...
    public int getContentViewResId() {
        return R.layout.activity_select_stop;
    }
    ...
    private void getProvinceHttp() {
        ...
        mProvinceList.clear();
        HttpRxUtils.getPositionList(SelectStopActivity.this,
                new String[]{"accessToken", "type", "language", "parentid"},
                new Object[]{new SharedPHelper(SelectStopActivity.this).get(Constant.ACCESSTOKEN, ""),
                        "dealerProvince", "", "0"
                },
                new HttpRxListener() {
                    @Override
