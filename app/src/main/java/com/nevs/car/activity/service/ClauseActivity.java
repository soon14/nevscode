...
public class ClauseActivity extends BaseActivity {
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {//定义一个Handler，用于处理下载线程与UI间通讯
            if (!Thread.currentThread().isInterrupted()) {
                switch (msg.what) {
                    case 0:
                        if (ClauseActivity.this.isFinishing())
                            return;
                        //pd.show();//显示进度对话框
                        DialogUtils.webloading(ClauseActivity.this, true, mDialog);
                        MLog.e("显示");
                        break;
                    case 1:
                        if (ClauseActivity.this.isFinishing())
                        ...
                        DialogUtils.webhidding(ClauseActivity.this, mDialog);
                        MLog.e("隐藏");
                        break;
                }
            }
    ...
    public void init(Bundle savedInstanceState) {
        ...
        ActivityManager.addActivity(ClauseActivity.this);
        next.setEnabled(false);
        next.setBackgroundResource(R.drawable.btn_unpress);
...
//    90071003	个人代理协议
//    90071002	个人代理介绍
        HttpRxUtils.getUrlProxy(mContext, "90071003",
                new HttpRxListener() {
                    @Override
    ...
    @OnClick({R.id.back, R.id.next, R.id.contentbottom})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.next:
//                if (isagree) {
//                    startActivity(new Intent(this, PersonAgentAllActivity.class));
//                } else {
//                    ActivityUtil.showToast(this, getResources().getString(R.string.toast_agreenext));
//                }
                startActivity(new Intent(this, PersonAgentAllActivity.class));
                break;
            case R.id.contentbottom:
                if (isagree) {
...
//            }
    ...
    private void initProgressDialog() {
        mDialog = DialogUtils.createLoadingDialog(ClauseActivity.this, getResources().getString(R.string.loading));
    }
...
//        return super.onKeyDown(keyCode, event);
        ...
        if ((keyCode == KeyEvent.KEYCODE_BACK) && wv.canGoBack()) {
            ...
            ClauseActivity.this.finish();//按了返回键，但已经不能返回，则执行退出确认
            return true;
        }
        return super.onKeyDown(keyCode, event);
    }
