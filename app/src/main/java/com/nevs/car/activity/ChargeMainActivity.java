...
public class ChargeMainActivity extends BaseActivity implements LocationSource, AMapLocationListener
    ...
    private void getList() {
        ...
        TspRxUtils.getStation(this,
                ...
                new Object[]{Constant.TSP.CONTENTTYPEVALUE, Constant.TSP.ACCEPTVALUE, "Bearer" + " " + new SharedPHelper(ChargeMainActivity.this).get(Constant.ACCESSTOKENS, "")},
                latme + "", lonme + "", "20",
                new TspRxListener() {
                    @Override
    ...
    private void initOnclickListener() {
        ...
        myAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                text = (String) listTsp.get(position).get("electricityFee");
...
//                        strokeWidth(15));
    ...
    @OnClick({R.id.start_local, R.id.btn_book, R.id.poi_close, R.id.btn_guides, R.id.back,
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        if (GaodeNaiUtils.isInstallPackage()) {
                            ...
                            ActivityUtil.showToast(ChargeMainActivity.this, getResources().getString(R.string.toast_installgao));
                        }
                        break;
                    case 1:
                        //百度地图
    ...
    public void onMapClick(LatLng latLng) {
        if (linDo.getVisibility() == View.VISIBLE) {
            linDo.setVisibility(View.GONE);
        }
        if (poiRel.getVisibility() == View.VISIBLE) {
            poiRel.setVisibility(View.GONE);
        }
...
//        aMap.animateCamera(cu);
        ...
        //CameraPosition4个参数分别为位置，缩放级别，目标可视区域倾斜度，可视区域指向方向（正北逆时针算起，0-360）
//        cameraUpdate = CameraUpdateFactory.newCameraPosition(new CameraPosition(latLngg, 10.4f, 0, 30));
//        aMap.moveCamera(cameraUpdate);//地图移向指定区域
