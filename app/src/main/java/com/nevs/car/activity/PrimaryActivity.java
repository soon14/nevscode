...
public class PrimaryActivity extends BaseActivity {
                ...
                switch (msg.what) {
                    case 0:
                        if (PrimaryActivity.this.isFinishing())
                            return;
                        //pd.show();//显示进度对话框
                        DialogUtils.webloading(PrimaryActivity.this, true, mDialog);
                        MLog.e("显示");
                        break;
                    case 1:
                        if (PrimaryActivity.this.isFinishing())
                        ...
                        DialogUtils.webhidding(PrimaryActivity.this, mDialog);
                        MLog.e("隐藏");
                        break;
                }
            }
    ...
    public void init(Bundle savedInstanceState) {
        ...
        initProgressDialog();
        initWebview();
        //initUrl("http://220.249.93.210:8602/web/yhxy.html");
        initUrl(Constant.HTTP.BANNERURL + "web/UserProtocol.html");
    }
...
//    90071002	个人代理介绍
    ...
    @OnClick({R.id.back, R.id.rl_title})
...
//            }
    ...
    private void initProgressDialog() {
        mDialog = DialogUtils.createLoadingDialog(PrimaryActivity.this, getResources().getString(R.string.loading));
    }
...
//        return super.onKeyDown(keyCode, event);
        ...
        if ((keyCode == KeyEvent.KEYCODE_BACK) && wv.canGoBack()) {
            ...
            PrimaryActivity.this.finish();//按了返回键，但已经不能返回，则执行退出确认
            return true;
        }
        return super.onKeyDown(keyCode, event);
    }
