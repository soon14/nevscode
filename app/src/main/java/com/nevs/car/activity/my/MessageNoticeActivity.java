...
//        }
    ...
    private void getList() {
        ...
        HttpRxUtils.getAnnouncement(
                ...
                new Object[]{new SharedPHelper(MessageNoticeActivity.this).get(Constant.ACCESSTOKEN, ""),
                        ""
                },
                new HttpRxListener() {
                    @Override
                    public void onSucc(Object list) {
                        DialogUtils.hidding(MessageNoticeActivity.this);
                        ...
                        if (lisNotice.size() == 0) {
                            ...
                            ActivityUtil.showToast(MessageNoticeActivity.this, getResources().getString(R.string.hint_un2));
        ...
        switch (view.getId()) {
            ...
            case R.id.text_all:
                if (lisNoticeOne.size() != 0) {
                    ...
                    ActivityUtil.showToast(mContext, getResources().getString(R.string.hint_un2));
                }
                break;
            ...
            public void onItemClick(View view, int position) {
                if (isEdit) {//编辑状态
                    ...
                    if (lisNoticeOne.get(position).get("is_read").equals("YES")) {
                        startActivity(new Intent(MessageNoticeActivity.this, PublicNoticeEnterActivity.class).putExtra("title",
                        ...
                        ).putExtra("bigtitle", getResources().getString(R.string.nevs_message)));
