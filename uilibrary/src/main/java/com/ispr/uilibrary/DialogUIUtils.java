...
import com.ispr.uilibrary.bean.BuildBean;
import com.ispr.uilibrary.bean.TieBean;
import com.ispr.uilibrary.listener.DialogAssigner;
import com.ispr.uilibrary.listener.DialogUIDateTimeSaveListener;
import com.ispr.uilibrary.listener.DialogUIItemListener;
import com.ispr.uilibrary.listener.DialogUIListener;
import com.ispr.uilibrary.listener.TdataListener;
import com.ispr.uilibrary.utils.ToolUtils;
import com.ispr.uilibrary.widget.PopuWindowView;
...
public class DialogUIUtils {
    ...
    public static void showPopuWindow(Context context, int widthGravity,int maxLine, View view, TdataListener tdataListener) {
        ...
        public static void main(String[] args){
            ...
            aa = aa.replaceAll("[^0-9]", "");  //去除数字，英文，汉字  之外的内容
