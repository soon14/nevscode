package com.ispr.uilibrary.widget;
...
import com.ispr.uilibrary.R;
import com.ispr.uilibrary.adapter.StrericWheelAdapter;
import com.ispr.uilibrary.listener.OnWheelChangedListener;
...
//            years[i] = 1960 + i + " 年";
            years[i] =String.format(getResources().getString(R.string.ui_year),1960 + i+"" );
        }
        /** 月初始化 */
        for (int i = 0; i < months.length; i++) {
            if (i < 9) {
//                months[i] = "0" + (1 + i) + " 月";
                months[i] =String.format(getResources().getString(R.string.ui_month), "0" + (1 + i) +"" );
            } else {
//                months[i] = (1 + i) + " 月";
                months[i] =String.format(getResources().getString(R.string.ui_month), 1 + i+"" );
            }
        }
        /** 日初始化 */
        for (int i = 0; i < tinyDays.length; i++) {
            if (i < 9) {
//                tinyDays[i] = "0" + (1 + i) + " 日";
                tinyDays[i] =String.format(getResources().getString(R.string.ui_day),"0" + (1 + i)+"" );
            } else {
//                tinyDays[i] = (1 + i) + " 日";
                tinyDays[i] =String.format(getResources().getString(R.string.ui_day), (1 + i)+"" );
            }
        }
        for (int i = 0; i < smallDays.length; i++) {
            if (i < 9) {
//                smallDays[i] = "0" + (1 + i) + " 日";
                smallDays[i] =String.format(getResources().getString(R.string.ui_day),"0" + (1 + i)+"" );
            } else {
//                smallDays[i] = (1 + i) + " 日";
                smallDays[i] =String.format(getResources().getString(R.string.ui_day), (1 + i)+"" );
            }
        }
        for (int i = 0; i < normalDays.length; i++) {
            if (i < 9) {
//                normalDays[i] = "0" + (1 + i) + " 日";
                normalDays[i] =String.format(getResources().getString(R.string.ui_day),"0" + (1 + i)+"" );

            } else {
//                normalDays[i] = (1 + i) + " 日";
                normalDays[i] =String.format(getResources().getString(R.string.ui_day), (1 + i)+"" );
            }
        }
        for (int i = 0; i < bigDays.length; i++) {
            if (i < 9) {
//                bigDays[i] = "0" + (1 + i) + " 日";
                bigDays[i] =String.format(getResources().getString(R.string.ui_day),"0" + (1 + i)+"" );
            } else {
//                bigDays[i] = (1 + i) + " 日";
                bigDays[i] =String.format(getResources().getString(R.string.ui_day), (1 + i)+"" );
            }
        }
        /** 时初始化 */
        for (int i = 0; i < hours.length; i++) {
            if (i <= 9) {
//                hours[i] = "0" + i + " 时";
                hours[i] =String.format(getResources().getString(R.string.ui_hour),"0" + i );
            } else {
//                hours[i] = i + " 时";
                hours[i] =String.format(getResources().getString(R.string.ui_hour),"" + i );
            }
        }
        /** 分初始化 */
        for (int i = 0; i < minutes.length; i++) {
            if (i <= 9) {
//                minutes[i] = "0" + i + " 分";
                minutes[i] =String.format(getResources().getString(R.string.ui_minute),"0" + i );
            } else {
//                minutes[i] = i + " 分";
                minutes[i] =String.format(getResources().getString(R.string.ui_minute),"" + i );
            }
        }
        /** 秒初始化 */
        for (int i = 0; i < seconds.length; i++) {
            if (i <= 9) {
//                seconds[i] = "0" + i + " 秒";
                seconds[i] =String.format(getResources().getString(R.string.ui_second),"0" + i );
            } else {
//                seconds[i] = i + " 秒";
                seconds[i] =String.format(getResources().getString(R.string.ui_second),"" + i );
            }
        }
...
//        year = year + " 年";
        year =String.format(getResources().getString(R.string.ui_year),year );
        for (int i = 0; i < years.length; i++) {
...
//        month = month + " 月";
        month =String.format(getResources().getString(R.string.ui_month),month );
        for (int i = 0; i < months.length; i++) {
...
//        day = day + " 日";
        day =String.format(getResources().getString(R.string.ui_day),day );
        for (int i = 0; i < smallDays.length; i++) {
    ...
    private boolean isLeapYear(String year) {
        year = year.replaceAll("[^0-9]", "");  //去除数字外
    ...
    public void onChanged(WheelView wheel, int oldValue, int newValue) {
        ...
        if (wheel.getId() == wvYear.getId()) {
            ...
            trim = (wvMonth.getCurrentItemValue())
                    .trim().split(" ")[0];
            trim = trim.replaceAll("[^0-9]", "");  //去除数字外
    ...
    public int getTodayHour() {
        ...
        hour= String.format(getResources().getString(R.string.ui_hour),hour);
        for (int i = 0; i < hours.length; i++) {
    ...
    public int getTodayMinute() {
        ...
        minute= String.format(getResources().getString(R.string.ui_minute),minute);
        for (int i = 0; i < minutes.length; i++) {
    ...
    public int getTodaySecond() {
        ...
        second= String.format(getResources().getString(R.string.ui_second),second);
        for (int i = 0; i < seconds.length; i++) {
